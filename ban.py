...
#상대 챔수: 74개 
#내ad 후보: 나피리, 올라프, 바이, 오공
#내ap 후보: 블라디미르, 신지드, 카이사, 트페
#새챔 후보: 렉사이, 나피리, 쉬바나, 애니비아
enemy_champions = \
[   
    "가렌", "갱플랭크", "그라가스", "그웬",
    "나르", "나서스", "녹턴",
...
preference = \
{
    "가렌": 1.0, "다리우스": 0.9, "나서스": 1.15, "베인": 0.8,
    "세트": 1.2, "암베사": 1.3, "우르곳": 1.1, "이렐리아": 0.7,
    "일라오이": 1.5, "자르반": 0.5, "잭스": 0.6, "제이스": 0.5,
    "그웬": 1.15, "라이즈": 1.1, "럼블": 0.6, "말파이트": 0.7, 
    "모데카이저": 1.25, "바루스": 0.9, "에코": 1.0, "오로라": 1.0,
    "오른": 0.8, "케넨": 1.5, "티모": 1.2, "쉬바나": 0.5
}
