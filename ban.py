...
preference = \
{
    "가렌": 1.3, "다리우스": 1.2, "레넥톤": 0.8, "나서스": 1.4, "베인": 1.1,
    "뽀삐": 0.8, "세트": 1.3, "암베사": 1.2, "올라프": 1.0, "우르곳": 0.9,
    "이렐리아": 0.8, "일라오이": 1.1, "자르반": 1.0, "자헨": 0.9, "잭스": 0.9,
    "그웬": 1.5, "라이즈": 1.2, "럼블": 0.8, "말파이트": 0.9, "모데카이저": 1.2,
    "바루스":1.1 , "쉬바나": 0.1, "스웨인": 0.8, "애니비아": 0.8, "에코": 1.0,
    "오로라": 0.7, "오른": 0.9, "케넨": 1.5, "카시오페아": 0.8, "티모": 1.1
}
