...
preference = \
{
    "가렌": 1.3, "다리우스": 1.0, "나서스": 0.8, "베인": 1.0,
    "세트": 1.0, "암베사": 1.0, "올라프": 0.8, "우르곳": 1.2,
    "이렐리아": 0.8, "일라오이": 1.1, "자르반": 1.0, "잭스": 0.9,
    "그웬": 1.3, "라이즈": 1.1, "럼블": 0.8, "말파이트": 0.9, 
    "모데카이저": 1.2, "바루스": 1.0 , "스웨인": 0.8, "에코": 1.0,
    "오로라": 0.6, "오른": 0.9, "케넨": 1.5, "티모": 1.1
}
